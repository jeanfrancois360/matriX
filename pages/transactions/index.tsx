                ...
                <div className='flex flex-row gap-24 space-around'>
                    <div className='flex gap-4 bg-slate-900 p-4 rounded-xl'>
                        ...
                        <div className='flex flex-col justify-around'>
                            ...
                            <p className="text-emerald-400 font-semibold">{account.balanceUSD != null ? account.balanceUSD:0}</p>
                        </div>
                    </div>
                    <div className='flex gap-4 bg-slate-900 p-4 rounded-xl'>
                        ...
                        <div className='flex flex-col justify-around'>
                            ...
                            <p className="text-emerald-400 font-semibold">{account.balanceNGN != null ? account.balanceNGN: 0}</p>
                        </div>
                    </div>
                    <div className='flex gap-4 bg-slate-900 p-4 rounded-xl'>
                        ...
                        <div className='flex flex-col justify-around'>
                            ...
                            <p className="text-emerald-400 font-semibold">{account.balanceEUR != null ? account.balanceEUR: 0}</p>
                        </div>
                    </div>
                </div>
